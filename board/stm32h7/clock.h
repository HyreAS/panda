void clock_init(void) {
  ...
  register_set(&(PWR->D3CR), PWR_D3CR_VOS_1 | PWR_D3CR_VOS_1, 0xC000U); //VOS1, needed for 80Mhz CAN FD
  ...
  register_set(&(RCC->D2CCIP2R), RCC_D2CCIP2R_USBSEL_1, RCC_D2CCIP2R_USBSEL); //PLL3Q at 48Mhz
  // Configure clock source for FDCAN
  register_set(&(RCC->D2CCIP1R), RCC_D2CCIP1R_FDCANSEL_0, RCC_D2CCIP1R_FDCANSEL); //PLL1Q at 80Mhz
